...
<dl>
  <dt>System Name</dt>
    <dd>
      <input type="text" name="system_name" value="<?php echo h($system->system_name); ?>" />
    </dd>
</dl>
...
<dl>
  ...
  <dd>
    <input type="text" name="latitude" value="<?php echo h($system->latitude); ?>" />
  </dd>
</dl>
...
<dl>
  ...
  <dd>
    <input type="text" name="longitude" value="<?php echo h($system->longitude); ?>" />
  </dd>
</dl>
...
<dl>
  <dt>Elevation</dt>
    <dd>
      <input type="text" name="elevation" value="<?php echo h($system->elevation); ?>" />
    </dd>
</dl>
...
<dl>
  <dt>Improved</dt>
    <dd>
      <input type="text" name="improved" value="<?php echo h($system->improved); ?>" />
    </dd>
</dl>
...
<dl>
  <dt>Functionality</dt>
    <dd>
      <input type="text" name="functionality" value="<?php echo h($system->functionality); ?>" />
    </dd>
</dl>
...
<dl>
  <dt>User Number</dt>
    <dd>
      <input type="text" name="number_users" value="<?php echo h($system->number_users); ?>" />
    </dd>
</dl>